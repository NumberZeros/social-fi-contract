...
> A Solana smart contract powering decentralized social networks with built-in creator economy.

Imagine Twitter/X where creators own their social graph, fans can invest in their favorite creators, and all transactions are transparent on-chain. This contract makes it possible.

## What Problem Does This Solve?

**Current Web2 social platforms:**
...
- Creators can't build equity in their brand

**This contract enables:**
- **Creator Shares** - Fans buy/sell shares in creators using bonding curve pricing
- **True Ownership** - Your profile, followers, and content relationships are on-chain
- **Direct Monetization** - Tips, subscriptions, and group memberships without middlemen
...
await program.methods
  .buyShares(creatorPubkey, amount, maxPricePerShare)
  .accounts({ ... })
  .rpc();

// Price increases as more people buy (bonding curve)
// Early supporters benefit from creator's growth

// Tip creators directly (no platform fee)
await program.methods
  .sendTip(creatorPubkey, tipAmount)
  .accounts({ ... })
  .rpc();
```
...
- **Creator Shares** - Quadratic bonding curve, built-in liquidity
- **Subscriptions** - Recurring payments with auto-renewal
- **Groups** - Public/private communities with roles
- **Governance** - Stake tokens, create proposals, vote
- **NFT Usernames** - Mint, trade, and own your handle
